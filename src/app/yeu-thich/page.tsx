      ...
      <div className="container mx-auto px-4 py-20 max-w-7xl">
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-20">
            ...
            <Link href="/">
              <Button className="bg-[#fb743E] hover:bg-[#fb743E]/90 text-white">
                Khám phá phim
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {favorites.map((favorite) => (
              ...
              >
                ...
                <div className="p-3">
                  <Link href={`/phim/${favorite.movie_slug}`}>
                    <h3 className="text-sm font-semibold text-white line-clamp-2 hover:text-[#fb743E] transition-colors">
                      {favorite.movie_name}
                    </h3>
                  </Link>
                </div>
