...
export function Header() {
  ...
  return (
    ...
    >
      <div className={`flex items-center justify-between px-3 sm:px-4 md:px-12 transition-all duration-500 ${isScrolled ? "h-10 sm:h-12 lg:h-14" : "h-16 sm:h-20 lg:h-[80px]"}`}>
        {/* Left Side */}
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-10 min-w-0">
          ...
          <Link href="/" className="flex items-center gap-1 sm:gap-1.5 shrink-0">
            ...
            <span className="text-lg sm:text-xl font-bold text-[rgb(255,220,120)] hidden sm:block">
              Phim7
            </span>
          </Link>
